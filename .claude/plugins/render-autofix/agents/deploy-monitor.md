...
whenToUse: |
  ...
  assistant: "I'll use the deploy-monitor agent to watch the PR for code review comments and track the deployment."
  </example>

  <example>
  Context: After fixing code, need to create PR and monitor deployment
  user: "코드 수정했으니 PR 만들고 배포까지 확인해줘"
  assistant: "I'll launch the deploy-monitor agent to create the PR and monitor the entire deployment process."
  </example>
---
