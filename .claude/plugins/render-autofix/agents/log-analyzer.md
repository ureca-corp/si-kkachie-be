...
whenToUse: |
  ...
  assistant: "I'll use the log-analyzer agent to analyze the Render logs and identify the issues."
  </example>

  <example>
  Context: The render-autofix command needs to analyze logs
  user: "/render-autofix:fix"
  assistant: "I'll launch the log-analyzer agent to fetch and analyze the deployment logs."
  </example>
---
